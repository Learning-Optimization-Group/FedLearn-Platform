"""
ECG Classification MLP Model
Simple 3-layer feedforward neural network for binary ECG classification.
Copied from framework/examples/ecg_decomfl_framework_integration/model.py
"""
