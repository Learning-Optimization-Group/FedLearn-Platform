...
class Config:
    ...
    CLIENT_FRACTION = 0.4  # Fraction of clients to sample each round (0.4 * 5 = 2 clients)
    ALPHA = 0.5  # Dirichlet parameter for non-IID data split

    # =========================================================================
    # DeComFL Algorithm Parameters (from Algorithm 3 & 4)
    # =========================================================================
    NUM_ROUNDS = 200  # R: Number of communication rounds
    ...
    def print_config(cls):
        ...
        print(f"  Clients per round: {max(1, int(cls.NUM_CLIENTS * cls.CLIENT_FRACTION))}")
        print(f"  Client fraction: {cls.CLIENT_FRACTION * 100}%")
