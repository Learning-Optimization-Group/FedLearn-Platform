import { evaluateEligibility, eligibilitySummary } from '../lib/evaluateEligibility';
import type { DeviceCapabilities, DeviceRequirements } from '../lib/deviceCapabilities.types';
