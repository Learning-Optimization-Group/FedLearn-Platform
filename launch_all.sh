...
printf "  4. Create a project (min 3 clients) → click Start Training\n"
printf "  5. Switch to Window 4 — once the backend is up it will prompt\n"
printf "     for your Project UUID and launch N-1 clients in new terminals\n"
...
printf "     and click Start Training to exercise the Docker path\n\n"
